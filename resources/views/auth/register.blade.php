        ...
        <div class="bg-navy-950/80 backdrop-blur-2xl rounded-3xl p-6 sm:p-8 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] border border-amber-500/30 ring-1 ring-white/10 space-y-4 text-white">
            ...
            <div class="text-center space-y-2">
                ...
                <div class="inline-flex items-center justify-center">
                    <div class="w-12 h-12 rounded-2xl overflow-hidden shadow-2xl bg-navy-900/90 p-1 border border-amber-500/40 ring-4 ring-amber-500/20">
                ...
                <div>
                    <span class="text-[10px] font-bold text-amber-400 uppercase tracking-widest block">Registrasi Akun Baru</span>
                    <h1 class="text-xl sm:text-2xl font-extrabold text-white tracking-tight drop-shadow">{{ \App\Models\SystemSetting::appName() }}</h1>
                </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3">
                ...
                <!-- Nama Lengkap -->
                <div class="space-y-1">
                    <label for="name" class="block text-[11px] font-bold text-amber-400 uppercase tracking-wider">
                        Nama Lengkap <span class="text-rose-400">*</span>
                    </label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                            <i class="fa-solid fa-user text-xs text-amber-400/80"></i>
                        </div>
                        <input 
                            id="name" 
                            type="text" 
                            ...
                            class="w-full pl-9 pr-4 py-2 bg-slate-900/80 border border-slate-700/90 rounded-xl text-xs font-medium text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-400 focus:bg-slate-900 transition shadow-inner"
                        >
                    </div>
                </div>
                ...
                <div class="space-y-1">
                    <label for="phone" class="block text-[11px] font-bold text-amber-400 uppercase tracking-wider">
                        Nomor HP / WhatsApp <span class="text-rose-400">*</span>
                    </label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="w-full pl-8 pr-3 py-2 bg-slate-900/80 border border-slate-700/90 rounded-xl text-xs font-medium text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-400 focus:bg-slate-900 transition shadow-inner"
                            >
                        </div>
                    </div>
            ...
            <div class="border-t border-slate-700/70 pt-2.5 text-center">
                <p class="text-xs text-slate-300">
                    Sudah memiliki akun?
                    <a href="{{ route('login') }}" class="font-bold text-amber-400 hover:text-amber-300 hover:underline">
                        Masuk ke Akun
                    </a>
                </p>
            </div>
